...
#include <stdbool.h>
#include <stdint.h>
typedef enum { TB_STATUS_CHECKING, TB_STATUS_CONNECTED, TB_STATUS_CONFIG_MISSING, TB_STATUS_CONFIG_INVALID, TB_STATUS_BACKEND_UNAVAILABLE, TB_STATUS_API_UNAUTHORIZED, TB_STATUS_BACKEND_NOT_READY, TB_STATUS_PROTOCOL_ERROR } TbStatus;
