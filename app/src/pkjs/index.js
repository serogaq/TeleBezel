...
require('./lib/runtime').create({Pebble: Pebble, Clay: Clay, storage: localStorage, protocol: protocol, settings: settings, transport: transport, reader: reader, configPage: require('./lib/config-page'), localization: require('./lib/localization'), locales: require('./lib/settings-locales.generated'), getLocale: function() { return typeof navigator !== 'undefined' && navigator.language ? navigator.language : 'en'; }}).register();
