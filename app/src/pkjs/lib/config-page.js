...
function build(s, state) {
  ...
  return [
    ...
    {type: 'radiogroup', id: 'unread_mode', messageKey: 'UNREAD_MODE', label: s.unread_mode, description: s.unread_mode_hint, defaultValue: 'chats',
