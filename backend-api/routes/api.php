...
Route::middleware(['api-client', 'api-client-rate-limit'])->prefix('/v1/telegram/accounts')->whereUuid('uuid')->group(function (): void {
    ...
    Route::get('/{uuid}/authorization', [TelegramAuthorizationController::class, 'show'])->middleware('account-management');
    ...
    Route::get('/{uuid}/proxy', [TelegramAccountController::class, 'proxy'])->middleware('account-management');
